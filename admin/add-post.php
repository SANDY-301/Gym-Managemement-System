...
$sql="INSERT INTO tbladdpackage (category,titlename,PackageType,PackageDuratiobn,Price,uploadphoto,Activities) 
Values(:category,:titlename,:package,:packageduratiobn,:Price,:photo,:Activities)";
                ...
                <div class="form-group col-md-6">
                 ...
                 <!-- <div class="form-group col-md-6">
                  ...
                  <div class="form-group col-md-6">
                   ...
                   <textarea name="description" id="Activities" class="form-control" cols="5" rows="10"></textarea> 
                 </div>
