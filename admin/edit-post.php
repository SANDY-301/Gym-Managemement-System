...
packageduratiobn=:packageduratiobn,Price=:Price,Activities=:Activities where id=:pid";
            ...
            <div class="tile-body">
              <form class="row" method="post">
                ...
                <div class="form-group col-md-6">
                  ...
                  <textarea name="Activities" id="Activities" class="form-control" cols="5" rows="10"><?php echo $result->Activities;?></textarea> 
                </div>
