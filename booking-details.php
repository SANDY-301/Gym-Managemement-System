...
t2.Price as Price,t2.Description as Activities,t4.category_name as category_name,t5.PackageName as PackageName,payment,paymentType FROM tblbooking as t1
...
on t2.PackageType=t5.id
 where t1.id=:bookindid";
                  ...
                  <tr>
                   <th>Activities</th>
                   <td colspan="3"><?php echo $result->Activities; ?></td>
